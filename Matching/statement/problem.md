...
　　「這我還是知道的。」藍嘀咕道。  
　　「雖然妳因為手腕扭到，只能畫出水平線、垂直線或左上到右下的直線。」（換句話說，除了斜率 $> 0$ 的線都可以畫。另外 $A_i$ 和 $B_i$ 點連線為水平線。）  
　　「不過把整張考卷順時針旋轉90度，讓 $A$ 區的點變成在上方，$B$ 區的點在下方，這樣妳不就可以連另一個方向的線了嗎？重複進行轉順時針、畫線、逆時針轉回去、畫線，不就能完成考卷了嗎？」  
　　「這樣不是要旋轉很多次嗎？」藍回應。  
